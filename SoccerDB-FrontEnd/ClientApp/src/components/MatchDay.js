          ...
          <Collapse in={open} timeout="auto" unmountOnExit>
            <Box sx={{ margin: 1 }}>
              ...
              <Table size="small" aria-label="purchases">
                <TableHead>
                  <TableRow>
                    <TableCell style={{'font-weight': '900'}}>{match.team1.name + ': ' + match.score1}</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {match.goals1!= null && match.goals1.map((goal,index) => (
              ...
              <Table size="small" aria-label="purchases">
                <TableHead>
                  <TableRow>
                    <TableCell style={{ 'font-weight': '900'}}>{match.team2.name + ': ' + match.score2}</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {match.goals2!=null && match.goals2.map((goal,index) => (
